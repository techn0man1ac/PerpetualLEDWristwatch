...
Кожні 0.5 секунди процесор прокидається(час ітерації циклу 100 мікросекунд), інкрементує змінну мілісекунд, та швиденько засипає, весь цей процес забирає споживання від 3 до 5 мкА:

https://youtu.be/rdMVb2fhGco

Наручний годиник має кнопку "NOW" та 12 світлодіодів, якщо натиснути кнопку - показується час на світлодіодах згідно з наступним алгоритмом - спочатку показуються години(1, 2, 3, 4, 5, 6 і так далі...) і потім показуються хвилини з кроком в 5 хв(5, 10, 15, 20, 25, 30 і так далі...), але світлодіод блимає стількм разів, скільки треба додати до цього числа щоб отримати час, наприклад зараз 48 хвилин, загориться світлодіод 45 і проблимає 3 рази, тобто 45+3=48. Далі -> знову сон.
...
Файли корпусу можна знайти за посиланням:

https://github.com/techn0man1ac/PerpetualLEDWristwatch/tree/main/LumiTime/Case

Зверніть увагу, що проект ще перебуває на стадії розробки і може зазнавати змін.
